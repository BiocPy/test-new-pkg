...
module_dir = os.path.join(__location__, "../src/my_new_package")
try:
...
try:
    from my_new_package import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "my-new-package-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "my-new-package Documentation", "Jayaram Kancherla", "manual")
]
