...
Welcome to `my-new-package` contributor's guide.
...
If you experience bugs or general issues with `my-new-package`, please have a look
...
You can help improve `my-new-package` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`my-new-package` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `my-new-package`'s files. While this mechanism can
...
```
conda create -n my-new-package python=3 six virtualenv pytest pytest-cov
conda activate my-new-package
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/my-new-package.git
   cd my-new-package
   ```
...
5. Install [pre-commit]:
   ...
   `my-new-package` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/my-new-package
[issue tracker]: https://github.com/<USERNAME>/my-new-package/issues
